...
def MAIN_MENU():
    ...
    if getSetEnabled('navi.tools') == True:
        CreateDir('Tools', 'url', 'tools', MENU_ICON, MENU_FANART, 'Tools Menu.', isFolder=True )
    if getSetEnabled('navi.utils') == True:
        CreateDir('Utilities', 'url', 'utilities', MENU_ICON, MENU_FANART, 'Utilities Menu.', isFolder=True )
    if getSetEnabled('navi.logs') == True:
        CreateDir('Logs', 'url', 'log_tools', MENU_ICON, MENU_FANART, 'Debug Logs Menu.')
    ...
    if getSetEnabled('navi.changelog') == True:
        CreateDir('ChangeLog', 'url', 'changeLog', control.AddonIcon, MENU_FANART, '%s ChangeLog.' %AddonTitle)
...
def MAINTENANCE():
    ...
    CreateDir( 'Clear Packages', 'url', 'deletePackages', MENU_ICON, MENU_FANART, 'description' )
...
def TOOLS():
    setView('addons', 'views')
    CreateDir( 'Backup/Restore', 'url', 'backup_restore', MENU_ICON, MENU_FANART, 'Backup and Restore Menu.' )
    CreateDir( 'Builds/Wizards', 'url', 'builds', MENU_ICON, MENU_FANART, 'Builds and Wizards Menu.', isFolder=True )
    CreateDir('AdvancedSettings', 'url', 'advancedSettings', MENU_ICON, MENU_FANART, 'Advanced Settings Menu.')
    CreateDir( 'Kodi ShortCuts', 'url', 'kodishortz', MENU_ICON, MENU_FANART, 'Useful Kodi Shortcuts to speed up Setup.' )
    CreateDir( 'Kodi DB ShortCuts', 'url', 'kodiDBshortz', MENU_ICON, MENU_FANART, 'Kodi Shortcuts for DB Stuff.' )
...
def UTILITIES():
    ...
    CreateDir( 'Enable Addons (ALL)', 'url', 'enableAddons', MENU_ICON, MENU_FANART, 'Enable All Addons.' )
...
def NETINFO():
    ...
    CreateDir('Internal IP: [ %s ]' % (inter_ip), '', '', MENU_ICON, MENU_FANART, '' )
...
def BUILDS():
    setView('addons', 'views')
    CreateDir('Kodi Version Check', 'url', 'getKodiVersion', MENU_ICON, MENU_FANART, 'Check My Kodi Version.' )
    CreateDir('Current Profile Check', 'url', 'checkCurrentProfile', MENU_ICON, MENU_FANART, 'Check My Current Profile.' )
    ...
    CreateDir('[I]Swap Skin[/I]', 'url', 'skinSWAP', MENU_ICON, MENU_FANART, 'Swap to Default Skin.')
    CreateDir('[I]Force Close Kodi[/I]', 'url', 'Force_Close', MENU_ICON, MENU_FANART, 'Force Close Kodi.' )
    CreateDir('[I]Reload Skin[/I]', 'url', 'reloadMySkin', MENU_ICON, MENU_FANART, 'Reload Current Skin.' )
    CreateDir('[I]Reload Profile[/I]', 'url', 'reloadProfile', MENU_ICON, MENU_FANART, 'Reload My User Profile.' )
    CreateDir('[I]Fresh Start[/I]', 'url', 'fresh_start', MENU_ICON, MENU_FANART, 'Wipe Kodi like a Factory Reset.' )
    CreateDir('Wizard Settings', 'url', 'wizSettings', MENU_ICON, MENU_FANART, 'Open up Wizard Settings.' )
